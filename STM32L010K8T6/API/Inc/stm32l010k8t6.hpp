...
class STM32L010K8T6
{
	...
	private:
		...
		inline STM32L010K8T6();
		STM32L010K8T6(const STM32L010K8T6& stm32l010k8t6) = delete;
		inline ~STM32L010K8T6();
...
inline STM32L010K8T6::STM32L010K8T6()
	: m_debug(),
		m_syscfg(),
		m_pwr(),
		m_flash(),
...
inline feedback STM32L010K8T6::startup()
{
...
constexpr inline PWR& STM32L010K8T6::get_pwr()
{
	return(m_pwr);
}


constexpr inline Flash& STM32L010K8T6::get_flash()
{
	return(m_flash);
}


constexpr inline RCC& STM32L010K8T6::get_rcc()
{
	return(m_rcc);
}


constexpr inline Debug& STM32L010K8T6::get_debug()
{
	return(m_debug);
}


constexpr inline GPIO& STM32L010K8T6::get_gpio()
{
	return(m_gpio);
}


constexpr inline EXTI& STM32L010K8T6::get_exti()
{
	return(m_exti);
}


constexpr inline RTC& STM32L010K8T6::get_rtc()
{
	return(m_rtc);
}


constexpr inline Timer_2& STM32L010K8T6::get_timer_2()
{
	return(m_timer_2);
}


constexpr inline DMA& STM32L010K8T6::get_dma(uint8 channel)
{
...
constexpr inline ADC& STM32L010K8T6::get_adc()
{
	return(m_adc);
}


constexpr inline USART_2& STM32L010K8T6::get_usart_2()
{
	return(m_usart_2);
}


constexpr inline I2C_1& STM32L010K8T6::get_i2c_1()
{
	return(m_i2c_1);
}