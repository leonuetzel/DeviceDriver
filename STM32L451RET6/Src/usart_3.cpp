...
feedback USART_3::init(uint32 baud, e_databits databits, e_parity parity, e_stopbits stopbits, uint8* rxBuffer, uint32 rxBufferSize, uint8* txBuffer, uint32 txBufferSize)
{
	...
	STM32L451RET6& stm32 = STM32L451RET6::get();
	{
		...
		m_dma_tx = &dma_tx;
		dma_tx.set_requestMapping(DMA_1::e_requestMapping::CH1_USART3TX);
	}
	...
	//	Lock Semaphore of Rx DMA
	{
		...
		m_dma_rx = &dma_rx;
		dma_rx.set_requestMapping(DMA_1::e_requestMapping::CH2_USART3RX);
	}
...
void ISR_USART_3()
{
	USART_3& usart = STM32L451RET6::get().get_usart_3();
