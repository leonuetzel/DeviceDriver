...
class STM32C071KBU6
{
	...
	private:
		...
		inline STM32C071KBU6();
		STM32C071KBU6(const STM32C071KBU6& stm32c071kbu6) = delete;
		inline ~STM32C071KBU6();
	...
	public:
		...
		inline static STM32C071KBU6& get();
...
inline STM32C071KBU6::STM32C071KBU6()
	: m_flash(),
		m_rcc(m_flash),
		m_crc(),
		m_dma(),
...
inline feedback STM32C071KBU6::startup()
{
	if(m_rcc.startup() != OK)
	{
		return(FAIL);
...
inline STM32C071KBU6& STM32C071KBU6::get()
{
	static STM32C071KBU6 stm32;
	return(stm32);
}
...
constexpr inline Flash& STM32C071KBU6::get_flash()
{
	return(m_flash);
}


constexpr inline RCC& STM32C071KBU6::get_rcc()
{
	return(m_rcc);
}


constexpr inline CRC& STM32C071KBU6::get_crc()
{
	return(m_crc);
}


constexpr inline DMA& STM32C071KBU6::get_dma(uint8 channel)
{
...
constexpr inline DMAMUX& STM32C071KBU6::get_dmamux()
{
	return(m_dmamux);
}


constexpr inline ADC& STM32C071KBU6::get_adc()
{
	return(m_adc);
}


constexpr inline PWR& STM32C071KBU6::get_pwr()
{
	return(m_pwr);
}


constexpr inline DBG& STM32C071KBU6::get_dbg()
{
	return(m_dbg);
}


constexpr inline GPIO& STM32C071KBU6::get_gpio()
{
	return(m_gpio);
}


constexpr inline EXTI& STM32C071KBU6::get_exti()
{
	return(m_exti);
}


constexpr inline Timer_17& STM32C071KBU6::get_timer_17()
{
	return(m_timer_17);
}


constexpr inline I2C_1& STM32C071KBU6::get_i2c_1()
{
	return(m_i2c_1);
}


constexpr inline USART_1& STM32C071KBU6::get_usart_1()
{
	return(m_usart_1);
}


constexpr inline USART_2& STM32C071KBU6::get_usart_2()
{
	return(m_usart_2);
}