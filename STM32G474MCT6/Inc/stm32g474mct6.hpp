...
class STM32G474MCT6
{
	...
	private:
		...
		inline STM32G474MCT6();
		STM32G474MCT6(const STM32G474MCT6& stm32g474mct6) = delete;
		inline ~STM32G474MCT6();
...
extern void ISR_RTC_TAMPER_CSS_LSE();
extern void ISR_RTC_WKUP();
...
extern void ISR_USB_HIGH_PRIORITY();
extern void ISR_USB_LOW_PRIORITY();
extern void ISR_FDCAN_1_IT0();
extern void ISR_FDCAN_1_IT1();
extern void ISR_EXTI_9_TO_5();
extern void ISR_TIMER_1_BREAK_TIMER_15();
extern void ISR_TIMER_1_UPDATE_TIMER_16();
extern void ISR_TIMER_1_TRIGGER_COMMUTATION_DIRECTION_INDEX_TIMER_17();
...
extern void ISR_USB_WAKEUP();
extern void ISR_TIMER_8_BREAK_TRANSITIONERROR_INDEXERROR();
extern void ISR_TIMER_8_UPDATE();
extern void ISR_TIMER_8_TRIGGER_COMMUTATION_DIRECTION_INDEX();
extern void ISR_TIMER_8_CAPTURE_COMPARE();
extern void ISR_ADC_3();
extern void ISR_FSMC();
...
extern void ISR_TIMER_7_DAC_UNDERRUN();
...
extern void ISR_ADC_4();
extern void ISR_ADC_5();
extern void ISR_UCPD();
extern void ISR_COMP_1_2_3();
extern void ISR_COMP_4_5_6();
extern void ISR_COMP_7();
...
extern void ISR_HR_TIMER_F();
extern void ISR_CRS();
extern void ISR_SAI();
extern void ISR_TIMER_20_BREAK_TRANSITIONERROR_INDEXERROR();
extern void ISR_TIMER_20_UPDATE();
extern void ISR_TIMER_20_TRIGGER_COMMUTATION_DIRECTION_INDEX();
extern void ISR_TIMER_20_CAPTURE_COMPARE();
extern void ISR_FPU();
extern void ISR_I2C_4_EVENT();
extern void ISR_I2C_4_ERROR();
extern void ISR_SPI_4();
extern void ISR_AES();
extern void ISR_FDCAN_2_IT0();
extern void ISR_FDCAN_2_IT1();
extern void ISR_FDCAN_3_IT0();
extern void ISR_FDCAN_3_IT1();
extern void ISR_RNG();
extern void ISR_LPUART_1();
extern void ISR_I2C_3_EVENT();
extern void ISR_I2C_3_ERROR();
extern void ISR_DMAMUX_OVERRUN();
...
extern void ISR_CORDIC();
extern void ISR_FMAC();
...
inline STM32G474MCT6::STM32G474MCT6()
	: m_dbg(),
		m_syscfg(),
		m_pwr(),
		m_flash(),
...
inline feedback STM32G474MCT6::startup()
{
	if(m_dbg.startup() != OK)
	{
		return(FAIL);
...
constexpr inline DBG& STM32G474MCT6::get_dbg()
{
	return(m_dbg);
}


constexpr inline SYSCFG& STM32G474MCT6::get_syscfg()
{
	return(m_syscfg);
}


constexpr inline PWR& STM32G474MCT6::get_pwr()
{
	return(m_pwr);
}


constexpr inline Flash& STM32G474MCT6::get_flash()
{
	return(m_flash);
}


constexpr inline RCC& STM32G474MCT6::get_rcc()
{
	return(m_rcc);
}


constexpr inline CRC& STM32G474MCT6::get_crc()
{
	return(m_crc);
}


constexpr inline GPIO& STM32G474MCT6::get_gpio()
{
	return(m_gpio);
}


constexpr inline EXTI& STM32G474MCT6::get_exti()
{
	return(m_exti);
}

/*
constexpr inline RTC& STM32G474MCT6::get_rtc()
{
	return(m_rtc);
}


constexpr inline Timer_2& STM32G474MCT6::get_timer_2()
{
	return(m_timer_2);
}

*/
constexpr inline DMA_1& STM32G474MCT6::get_dma_1(uint8 channel)
{
...
constexpr inline DMA_2& STM32G474MCT6::get_dma_2(uint8 channel)
{
...
constexpr inline DMAMUX& STM32G474MCT6::get_dmamux()
{
	return(m_dmamux);
}


constexpr inline ADC_1& STM32G474MCT6::get_adc_1()
{
	return(m_adc_1);
}


constexpr inline I2C_1& STM32G474MCT6::get_i2c_1()
{
	return(m_i2c_1);
}


constexpr inline I2C_2& STM32G474MCT6::get_i2c_2()
{
	return(m_i2c_2);
}


constexpr inline I2C_3& STM32G474MCT6::get_i2c_3()
{
	return(m_i2c_3);
}


constexpr inline I2C_4& STM32G474MCT6::get_i2c_4()
{
	return(m_i2c_4);
}


constexpr inline USART_1& STM32G474MCT6::get_usart_1()
{
	return(m_usart_1);
}


constexpr inline USART_2& STM32G474MCT6::get_usart_2()
{
	return(m_usart_2);
}


constexpr inline USART_3& STM32G474MCT6::get_usart_3()
{
	return(m_usart_3);
}
...
constexpr inline Timer_3& STM32G474MCT6::get_timer_3()
{
	return(m_timer_3);
}
