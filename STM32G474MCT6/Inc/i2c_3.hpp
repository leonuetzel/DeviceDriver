...
class I2C_3: public I_I2C
{
	...
	public:
		...
		feedback init(e_mode mode = e_mode::FAST_400KHZ, RCC::e_clockSource_i2c_3 clockSource = RCC::e_clockSource_i2c_3::APB1, bool analogFilterEnable = true, uint8 digitalFilterLength = 0);
