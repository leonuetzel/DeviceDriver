...
class RCC
{
	...
	public:
		...
		feedback set_clockSource(e_clockSource_lpuart_1 clockSource);
...
constexpr inline RCC::RCC(Flash& flash)
	:	m_flash(flash),
		...
		m_clockSource_lpuart_1(e_clockSource_lpuart_1::BUSCLOCK),
