...
class ADC_2
{
	...
	private:
		...
		constexpr inline ADC_2();
		ADC_2(const ADC_2& adc_2) = delete;
		inline ~ADC_2();
...
inline uint16 ADC_2::operator[](uint8 channel) const
{
