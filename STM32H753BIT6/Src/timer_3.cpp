...
feedback Timer_3::init(uint32 frequency, bool enableInterrupt)
{
	...
	*MCU::TIMER_3::ARR = (clock_divided / frequency) - 1;
	...
	bit::set(*MCU::TIMER_3::CR1, 2);                                                                                              //  Only OVF/UVF triggers Interrupt
	
	bit::set(*MCU::TIMER_3::CR1, 0);                                                                                              //  Enable Timer
	return(OK);
}
	...
	switch(channel)
	{
		case e_channel::CHANNEL_1:
			...
			*MCU::TIMER_3::CCMR1 |= 0x60;
			bit::clear(*MCU::TIMER_3::CCER, 1);                                                                                       //  Channel 1 Active High
			bit::set(*MCU::TIMER_3::CCER, 0);                                                                                         //  Channel 1 Enable
			break;
		
		case e_channel::CHANNEL_2:
			*MCU::TIMER_3::CCMR1 &= 0x00FF;
			*MCU::TIMER_3::CCMR1 |= (0x60 << 8);
			bit::clear(*MCU::TIMER_3::CCER, 5);                                                                                       //  Channel 2 Active High
			bit::set(*MCU::TIMER_3::CCER, 4);                                                                                         //  Channel 2 Enable
			break;
			
		case e_channel::CHANNEL_3:
			*MCU::TIMER_3::CCMR2 &= 0xFF00;
			*MCU::TIMER_3::CCMR2 |= 0x60;
			bit::clear(*MCU::TIMER_3::CCER, 9);                                                                                       //  Channel 3 Active High
			bit::set(*MCU::TIMER_3::CCER, 8);                                                                                         //  Channel 3 Enable
			break;

		case e_channel::CHANNEL_4:
			*MCU::TIMER_3::CCMR2 &= 0x00FF;
			*MCU::TIMER_3::CCMR2 |= (0x60 << 8);
			bit::clear(*MCU::TIMER_3::CCER, 13);                                                                                      //  Channel 4 Active High
			bit::set(*MCU::TIMER_3::CCER, 12);                                                                                        //  Channel 4 Enable
			break;
...
CODE_RAM void Timer_3::set_pwm(e_channel channel, uint32 dutycycle_ppm)
{
