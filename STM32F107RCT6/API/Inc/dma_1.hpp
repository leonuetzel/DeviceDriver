...
class DMA_1 : public I_DMA
{
	...
	private:
		...
		DMA_1(const DMA_1& dma_1) = delete;
		inline ~DMA_1();
		...
		friend void ISR_DMA1_CH1();
		friend void ISR_DMA1_CH2();
		friend void ISR_DMA1_CH3();
		friend void ISR_DMA1_CH4();
		friend void ISR_DMA1_CH5();
		friend void ISR_DMA1_CH6();
...
inline feedback DMA_1::startup(RCC& rcc, uint8 channel)
{
	...
	if(channel == 0)
	{
		...
		nvic.setPriority(Interrupt::DMA1_CH2, 10);
		nvic.setPriority(Interrupt::DMA1_CH3, 10);
		nvic.setPriority(Interrupt::DMA1_CH4, 10);
		nvic.setPriority(Interrupt::DMA1_CH5, 10);
		nvic.setPriority(Interrupt::DMA1_CH6, 10);
		
		nvic.enable(Interrupt::DMA1_CH0);
		nvic.enable(Interrupt::DMA1_CH1);
		nvic.enable(Interrupt::DMA1_CH2);
		nvic.enable(Interrupt::DMA1_CH3);
		nvic.enable(Interrupt::DMA1_CH4);
		nvic.enable(Interrupt::DMA1_CH5);
		nvic.enable(Interrupt::DMA1_CH6);
