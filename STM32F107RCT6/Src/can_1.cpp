...
feedback CAN_1::init(uint32 baudRate, uint32 rxBufferSize, uint32 txBufferSize)
{
	...
	*MCU::CAN_1::F0R2 = 0;
	...
	nvic.setPriority(Interrupt::CAN1_TX,		10);
	nvic.setPriority(Interrupt::CAN1_RX0,	10);
	nvic.setPriority(Interrupt::CAN1_RX1,	10);
	nvic.setPriority(Interrupt::CAN1_SCE,		10);
	nvic.enable(Interrupt::CAN1_TX);
	nvic.enable(Interrupt::CAN1_RX0);
	nvic.enable(Interrupt::CAN1_RX1);
	nvic.enable(Interrupt::CAN1_SCE);
