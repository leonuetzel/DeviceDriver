...
namespace MCU
{
	namespace BASE
	{
		...
		constexpr uint32 I2C			    							= APB 		+ 0x00005400;
		...
		constexpr uint32 SPI												= APB 		+ 0x00013000;
	...
	namespace I2C
	{
		volatile uint32* const CR1			  					= (volatile uint32* const) (BASE::I2C + 0x00);
		volatile uint32* const CR2									= (volatile uint32* const) (BASE::I2C + 0x04);
		volatile uint32* const OAR1			  					= (volatile uint32* const) (BASE::I2C + 0x08);
		volatile uint32* const OAR2			  					= (volatile uint32* const) (BASE::I2C + 0x0C);
		volatile uint32* const TIMINGR							= (volatile uint32* const) (BASE::I2C + 0x10);
		volatile uint32* const TIMEOUTR							= (volatile uint32* const) (BASE::I2C + 0x14);
		volatile uint32* const ISR			  					= (volatile uint32* const) (BASE::I2C + 0x18);
		volatile uint32* const ICR			  					= (volatile uint32* const) (BASE::I2C + 0x1C);
		volatile uint32* const PECR			  					= (volatile uint32* const) (BASE::I2C + 0x20);
		volatile uint32* const RXDR			  					= (volatile uint32* const) (BASE::I2C + 0x24);
		volatile uint32* const TXDR			  					= (volatile uint32* const) (BASE::I2C + 0x28);
	};
	...
	namespace SPI
	{
		volatile uint32* const CR1		    			    = (volatile uint32* const) (BASE::SPI + 0x00);
		volatile uint32* const CR2       						= (volatile uint32* const) (BASE::SPI + 0x04);
		volatile uint32* const SR			        			= (volatile uint32* const) (BASE::SPI + 0x08);
		volatile uint32* const DR					        	= (volatile uint32* const) (BASE::SPI + 0x0C);
		volatile uint32* const CRCPR     						= (volatile uint32* const) (BASE::SPI + 0x10);
		volatile uint32* const RXCRCR	    					= (volatile uint32* const) (BASE::SPI + 0x14);
		volatile uint32* const TXCRCR		    				= (volatile uint32* const) (BASE::SPI + 0x18);
		volatile uint32* const I2SCFGR			    		= (volatile uint32* const) (BASE::SPI + 0x1C);
		volatile uint32* const I2SPR     						= (volatile uint32* const) (BASE::SPI + 0x20);
	};
