...
void RTC::enter()
{
	...
	STM32F103C8T6::get().get_pwr().set_backupDomain_writeProtection(false);
...
void RTC::exit()
{
	...
	STM32F103C8T6::get().get_pwr().set_backupDomain_writeProtection(true);
}
